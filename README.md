...
## Limitation
This add-on is tested for Firefox only. Theoretically, the WebExtension standard should make this work with Chrome as well, but there are a lot of Firefox only hacks done (ex. the newtab behavior, the background script declaration, and hiding the scroll bar).
